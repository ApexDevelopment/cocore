...
const SESSION_IDLE_TIMEOUT_MS = Number(
  process.env["COCORE_ADVISOR_SESSION_IDLE_TIMEOUT_MS"] ?? 90_000,
);
...
const SESSION_FIRST_CHUNK_TIMEOUT_MS = Number(
  process.env["COCORE_ADVISOR_SESSION_FIRST_CHUNK_TIMEOUT_MS"] ?? 120_000,
);
